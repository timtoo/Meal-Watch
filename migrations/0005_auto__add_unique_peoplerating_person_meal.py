...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PeopleRating', fields ['person', 'meal']
        db.create_unique(u'dinner_peoplerating', ['person_id', 'meal_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PeopleRating', fields ['person', 'meal']
        db.delete_unique(u'dinner_peoplerating', ['person_id', 'meal_id'])
